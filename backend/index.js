...
app.post('/task',jsonParser,Task.Addtask)
app.post('/alltask',jsonParser,Task.Alltasks)
app.post('/deletetask',jsonParser,Task.Deletetask)
app.post('/ticktask',jsonParser,Task.Ticktask)
